...
export const WishItemCard = ({ wishItem, selectWish }: { wishItem: Wish,  selectWish: any  }) => {
    ...
    return (
        <div className="w-[16rem] px-2 pt-4 bg-white rounded-xl flex-col border-2 border-b-neutral-100 items-center gap-3 inline-flex">
            <div className="flex justify-end w-full gap-1.5">
                <BsCheckCircle/>
                <BsXCircle />
            </div>
            <div className=" sm:w-[14rem] h-[14rem] bg-zinc-300 rounded-lg mb-3" style={{ backgroundImage: `url(${localWish.imageUrl})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}></div>
            <div className="items-center w-full gap-[10px] flex flex-col px-2">
                ...
                <div className="justify-end flex h-[70px]">
                    <div className="whitespace-normal w-[14rem] text-black text-[17px] font-['Inter']">{formatName(localWish.name)}</div>
                </div>
            </div>
