            ...
            <div className="absolute inset-x-0 top-0 z-50 ">
                <nav className="flex items-center justify-between  lg:px-8 bg-gray-700 h-16" aria-label="Global">
                    ...
                    <div className="lg:flex lg:flex-1 lg:justify-end">
                        ...
                        {user ? (
                            <div>
                                <span className="px-2 text-white text-xl font-normal font-['Inter']">{user.data.email}</span>
                                <button onClick={logout} className="text-white text-xl font-normal font-['Inter']">
                                    Log out
                                </button>
                            </div>
                        ) : (
